...
<script src="./js/testeBairro.js"></script>
...
<body onload="teste()">
	...
	<input type="hidden" value="bairro">
				...
				<div class="form-row" style="margin-top: 10%;">
					...
					<div class="form-group col-md-6">
						<label for="inputCity">Cidade <img id="imgCidade"
							...
							src="./img/adicionar.png"></label> <select id="cidades"
							name="cidades" class="cidades form-control"></select>
					</div>

					<div class="form-group col-md-6">
						<label for="inputAddress">Bairro</label> <input type="text"
							class="form-control" name="bairro" id="endereco"
							placeholder="Rua dos Bobos, nº 0"> <input type="hidden"
							name="cadastrarBairro" value="cadastrarBairro">
					</div>
